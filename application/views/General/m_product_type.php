...
<?php
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $("#master_table").dataTable({
                        ...
                        stateSave: true,
                        columns: [
                            { "data": "m_product_type_id", "render": function (data, type, row, meta) {
                            ...
                            { "data": "m_product_type_status", "render": function (data, type, row, meta) {
                                    return data;
                                }
                            },
                            {  "data": "aksi", className: 'text-nowrap', "render": function (data, type, row, meta) {
                                    var id = row.m_product_type_id;
    ...
    function insert_handler($data,$aksi){
        ...
        $m_product_type_name = $count==0?"":$item['m_product_type_name'];
        $m_product_type_status = $count==0?"Active":$item['m_product_type_status'];
        $read_only = false;
        
        if($count>0){
            $m_product_type_status = $m_product_type_status=="Active"?true:false;
            $read_only = $m_product_type_status==true?false:true;
        }
        
        $input =  
            get_input("m_product_type_id","Id","hidden",true,$m_product_type_id)
            .get_group_input("m_product_type_name","Name","text",50,true,$m_product_type_name,$read_only)
            .get_group_toggle("m_product_type_status","Status",true,$m_product_type_status,$read_only)
            ;
        echo $input;
    }
?>