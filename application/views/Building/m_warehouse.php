...
<?php
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $("#master_table").dataTable({
                        ...
                        stateSave: true,
                        columns: [
                            { "data": "m_warehouse_id", "render": function (data, type, row, meta) {
                            ...
                            { "data": "m_warehouse_telp", "render": function (data, type, row, meta) {
                                    return data;
                                }
                            },
                            { "data": "m_warehouse_status", "render": function (data, type, row, meta) {
                                    return data;
                                }
                            },
                            {  "data": "aksi", className: 'text-nowrap', "render": function (data, type, row, meta) {
                                    var id = row.m_warehouse_id;
    ...
    function insert_handler($data,$aksi){
        ...
        $input =  
            get_input("m_warehouse_id","Id","hidden",true,$m_warehouse_id)
            .get_group_input("m_warehouse_name","Name","text",50,true,$m_warehouse_name,$read_only)
            .get_group_input("m_warehouse_telp","Telephone","number",50,true,$m_warehouse_telp,$read_only)
            .get_group_toggle("m_warehouse_status","Status",true,$m_warehouse_status,$read_only)
            ;
        echo $input;
    }
?>