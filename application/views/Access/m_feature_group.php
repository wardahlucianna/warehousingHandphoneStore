            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $("#master_table").dataTable({
                        ...
                        stateSave: true,
                        columns: [
                            { "data": "m_feature_group_id", "render": function (data, type, row, meta) {
                            ...
                            { "data": "m_feature_group_url", "render": function (data, type, row, meta) {
                                    return data;
                                }
                            },
                            { "data": "m_feature_group_icon", "render": function (data, type, row, meta) {
                                    return data;
                                }
                            },
                            { "data": "m_feature_group_status", "render": function (data, type, row, meta) {
                                    return data;
                                }
                            },
                            {  "data": "aksi", className: 'text-nowrap', "render": function (data, type, row, meta) {
                                    var id = row.m_feature_group_id;
