...
<?php
                ...
                $(document).ready(function(){
                    $("#master_table").dataTable({
                        ...
                        columns: [
                            ...
                            { "data": "m_user_group_status", "render": function (data, type, row, meta) {
                                    return data;
                                }
                            },
    ...
    function insert_handler($data,$aksi){
        ...
        $m_user_group_name = $count==0?"":$item['m_user_group_name'];
        $m_user_group_status = $count==0?"Active":$item['m_user_group_status'];
        $read_only = false;
        
        if($count>0){
            $m_user_group_status = $m_user_group_status=="Active"?true:false;
            $read_only = $m_user_group_status==true?false:true;
        }
        
        $input =  
            get_input("m_user_group_id","Id","hidden",true,$m_user_group_id)
            .get_group_input("m_user_group_name","Name","text",50,true,$m_user_group_name,$read_only)
            .get_group_toggle("m_user_group_status","Status",true,$m_user_group_status,$read_only)
            ;
        echo $input;
    }
?>